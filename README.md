...
2023 年 8 月の食費のほうが意味があります。Qash でこれを表示させる方法は後述します。
...
カードサイトからダウンロードした買い物履歴を Qash で取り扱いたくなります。
Qash の `of-json` サブコマンドを使うと、JSON 形式で取引情報を入力し、
Qash プログラムに変換することができます。
